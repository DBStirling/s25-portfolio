    ...
    <div className='device-container'>
      <div className="main-content-case">
        <div className="sub-section introduction">
          <div className="title">
          Bridging the Gap Between Exploration and Commitment Through a Hybrid Trial Experience at LIV 
          </div>
          <div className="context">
            ...
            <div className="ht-pair">
              ...
              <div>
              <p>LIV is <b>an all-in-one property management solution</b> offered by Unify, a Canadian prop-tech 
            ...
            <div className="ht-pair">
              ...
              <div>
              <p>
                As their first intern and second UX Designer, <b>I had the opportunity to shape their internship 
                program and work as the lead designer for high-impact features shipping in early 2025.</b> 
              </p>
              <p>
